...
const TableTemplate = () => {
  ...
  return(
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ marginLeft:10, backgroundColor:'white', shadowColor:'#000', shadowOpacity: .1 ,shadowOffset:{width:0, height:1}, width:400, height:'auto'}}>
          {/* Title */}
          ...
          <View style={styles.data}>
              ...
              <Image source={require('../../../assets/images/club1.png')} style={styles.img} />
