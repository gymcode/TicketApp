  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contact}>
        ...
        <Text style={{ marginLeft: 10, marginTop: 5, color: "#073068" }}>
          Send us an email:{" "}
          <Text style={{ fontSize: 15, fontFamily: "TTCommons-Bold" }}>
            ticketPouch@gmail.com
          </Text>
        </Text>
      </View>
      <View style={styles.contact}>
      ...
      <View style={{ flexDirection: "row", marginTop: 100 }}>
        <Text style={{ marginLeft: 10, marginTop: 5, color: "grey" }}>
          Copyright <AntDesign name="copyright" size={13} color="grey" /> 2020
          Ticket Pouch. All rights reserved
        </Text>
      </View>
    </View>
  );
