        ...
        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
          ...
          <View>
            ...
            <View style={styles.social}>
              <TouchableOpacity style={[{backgroundColor: '#4b76eb',}, styles.shadow]}>
                <Text style={styles.facebook}>Facebook</Text>
              </TouchableOpacity>
                <TouchableOpacity style={[{ marginLeft: 10,   backgroundColor: '#1DA1EF' }, styles.shadow]}>
                <Text style={styles.twitter}>Twitter</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[{ marginLeft: 10,backgroundColor: '#ff3046'}, styles.shadow]}>
