        ...
        <View style={{ marginTop: 32, alignSelf: 'flex-start', padding: 5 }}>
          ...
          <TouchableOpacity onPress={openModal} style={styles.selectTeam}>
            <View style={{flexDirection:'row', alignItems:'center'}}>
               <Image source={club.logo} style={{width:30, height:30, borderRadius:15}} />
               <Text style={{marginLeft:10, fontWeight:'500'}}>{club.name}</Text>
            </View>
            <Ionicons name="ios-arrow-down" size={18} color="grey" />
            <SelectTeams selectedTeam={selectedTeam} visible={visible} closeButton={closeButton} />
          </TouchableOpacity>
          <View
            style={{
              marginTop: 32,
